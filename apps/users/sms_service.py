...
def send_otp_sms(phone: str, code: str) -> bool:
    ...
    """
    if settings.DEBUG and getattr(settings, "SMS_SKIP_IN_DEV", False):
        # Development da SMS yubormasdan console ga chiqaradi
        logger.warning(f"[DEV] SMS not sent. OTP for {phone}: {code}")
        return True
